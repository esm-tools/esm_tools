...
requirements = [
    "esm_master @ git+https://github.com/esm_tools/esm_master.git",
    "esm_runscripts @ git+https://github.com/esm_tools/esm_runscripts.git",
    "esm_rcfile @ git+https://github.com/esm_tools/esm_rcfile.git",
    "esm_version_checker @ git+https://github.com/esm_tools/esm_version_checker.git",
]
