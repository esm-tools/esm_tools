def prepare_environment(config):
    environment_dict = {
            ...
            "CHUNK_END_DATE_fesom": config["general"]["final_date"],
            "FUNCTION_PATH": "/work/ollie/lackerma/processor-partitioning/software/github.com/esm-tools/esm_tools/runscripts/awicm-pism/coupling",
