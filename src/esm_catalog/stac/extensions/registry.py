...
EXTENSION_URLS: dict[str, str] = {
    ...
    # Custom extensions — spec documents TBD
    "hpc": "https://esm-tools.github.io/stac-hpc-extension/v0.1.0/schema.json",
    "paleo": "https://esm-tools.github.io/stac-paleo-extension/v0.1.0/schema.json",
    "namelist": "https://esm-tools.github.io/stac-namelist-extension/v0.1.0/schema.json",
}
