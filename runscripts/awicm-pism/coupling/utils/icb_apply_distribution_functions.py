...
class IcebergCalving:
    def __init__(self, ifile, mesh_path, icb_path, basin_file):
        ...
        self.name_of_discharge = "tendency_of_ice_amount_due_to_discharge" #"tendency_of_ice_mass_due_to_discharge"
        self.rho_ice = 920
    ...
    ######################################
        ...
        thick = x**(1/2)
        print("LA DEBUG: min(x) = ", min(x))
        print("LA DEBUG: thick = ", thick[thick<self.thick_max])
