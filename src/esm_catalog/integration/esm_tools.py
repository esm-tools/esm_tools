...
def add_files(
    ...
    Args:
        ...
        checksums:         Optional mapping of ``str(resolved_path)`` → MD5 hex
                           ...
                           :func:`get_outdata_from_file_operations`.
    ...
    with CatalogDB(db) as catalog_db:
        for raw_path in files:
            ...
            try:
                ...
                # Inject checksum from file_operations_tidy log when available
                if checksums:
...
def add_run(
    ...
    # Priority 1: file_operations_tidy log (checksums included)
    ...
    if log_path:
        ...
        # Priority 2: finished_config outdata_targets (paths only)
