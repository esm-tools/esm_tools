def prepare_environment(config):
    environment_dict = {
            ...
            "script_name": config["fesom"].get("script_name", "fesom_scalar_array_to_LonLat.py"),
            "iter_coup_interact_method_oce2ice": config["fesom"].get("iter_coup_interact_method_oce2ice", "OCEANTEMPSALT"),
