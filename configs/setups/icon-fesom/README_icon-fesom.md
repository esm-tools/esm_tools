...
```
To do an "operational" with yearly restarts, please see comments in `icon-fesom-pictl.yaml`.
...
* Only R2B4 is supported, once input files for R2B5 are available, support for R2B5 will be added by Sebastian Wahl
* Input data is taken from `/work/bb0519/foci_input2/ICON-FESOM/`.For now, the directory structure initially used by Sveta was kept. May change in the future.

## Contact
For questions on ICON-FESOM within ESM-Tools, please contact Sebastian Wahl (swahl@geomar.de).
