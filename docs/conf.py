...
components = {}
for component in [
    "../configs/components/" + c for c in os.listdir("../configs/components")
]:
...
with open("Utils.rst", "w") as rst:
    rst.write("=============================\n")
    rst.write("ESM Tools Auxillary Utilities\n")
    rst.write("=============================\n")
    rst.write(".. toctree::\n")
    rst.write("   :glob:\n\n")
    rst.write("   utils/*")
...
sphinx.ext.apidoc.main(
    ["--no-toc", "--module-first", "--output-dir", "utils", "../utils"]
)
