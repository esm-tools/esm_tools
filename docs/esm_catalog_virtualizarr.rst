...
From STAC Discovery to Virtual Zarr Cube
----------------------------------------
...
`VirtualiZarr <https://github.com/zarr-developers/VirtualiZarr>`_ — without copying
...
Workflow 1: In-memory virtual cube
----------------------------------
...
`Icechunk <https://icechunk.io>`_ stores manifests in a versioned, transactional
...
.. code-block:: python
    ...
    storage = icechunk.local_filesystem_storage("/path/to/stores/basic-001-fesom-ssh")
...
.. code-block:: json

    {
      "assets": {
        "data": {
          "href": "file:///path/to/ssh.fesom.185001.nc",
          "type": "application/x-netcdf"
        },
        "zarr_manifest": {
          "href": "file:///path/to/ssh.fesom.185001.kerchunk.json",
...
- `VirtualiZarr documentation <https://virtualizarr.readthedocs.io>`_
- `Kerchunk <https://fsspec.github.io/kerchunk/>`_
- `Icechunk <https://icechunk.io>`_
- `ESM Catalog source <https://github.com/esm-tools/esm_tools/tree/main/src/esm_catalog>`_
