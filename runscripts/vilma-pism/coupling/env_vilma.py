def prepare_environment(config):
    ...
    environment_dict = {
        ...
        "solidearth_ice_thickness_file": (
            config["general"]["experiment_couple_dir"] + "/ice_thickness.nc"
        ),
        ...
        "RESTART_DIR_vilma": config["vilma"]["experiment_restart_out_dir"],
        "OUTDATA_DIR_vilma": config["vilma"]["experiment_outdata_dir"],
