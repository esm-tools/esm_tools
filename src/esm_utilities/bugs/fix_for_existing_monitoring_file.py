...
from .check_for_existing_monitoring_file import parse_args
from .check_for_existing_monitoring_file import (
    main as check_for_existing_monitoring_file,
)
...
def main():
    ret_code = check_for_existing_monitoring_file()
    if ret_code == 0:
        return ret_code
    ...
    print(
        f"As the existing monitoring file can just be erased, we resubmit after cleaning up..."
    )
    print()
