...
from .check_for_windspeed import parse_args
from .check_for_windspeed import main as check_for_windspeed
...
def main():
    ...
    print("Current contents of disturb_years.dat")
    if os.path.exists(script_dir + "/disturb_years.dat"):
        with open(script_dir + "/disturb_years.dat", "r") as disturb_years:
            print(disturb_years.read())
    print(f"Adding {year} to disturb_years.dat in scripts folder")
    with open(script_dir + "/disturb_years.dat", "a") as disturb_years:
        disturb_years.write("\n" + year)
    print("Updated contents of disturb_years.dat")
    with open(script_dir + "/disturb_years.dat", "r") as disturb_years:
        print(disturb_years.read())
    print()
    ...
    # Also remove monitoring file without year
    monitoring_file = script_dir + f"/monitoring_file.out"
    if os.path.exists(monitoring_file):
        os.remove(monitoring_file)
