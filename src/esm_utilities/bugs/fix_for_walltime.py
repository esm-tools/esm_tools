...
from .check_for_walltime import parse_args
from .check_for_walltime import main as check_for_walltime
...
def main():
    ...
    print(f"As TIME LIMIT errors may be due to I/O problems, I will just resubmit")
    print()
